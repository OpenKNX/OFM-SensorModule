...
* FIX: Der BMP280 kann nur Temperatur und Luftdruck messen, nicht wie initial angenommen, Temperatur und Luftfeuchte. Das ist jetzt korrigiert

13.01.2025: Firmware 4.1.7, Applikation 4.1
...
Bei einer Erstinbetriebnahme, nach dem Einspielen einen neuen Firmware oder in seltenen Fällen auch im normalen Betrieb ist es notwendig, dass sich der Sensor BME680 neu kalibriert. Dies ist daran zu erkennen, dass der Sensor für den Voc-Wert konstant eine 25 liefert und als Kalibrierungsfortschritt der Wert 0% geliefert wird.

Nach ca. 5 Minuten (Nutzer haben auch längere Zeiten gemeldet) werden die ersten Voc-Werte ungleich 25 geliefert mit einem Kalibrierungsfortschritt von 33%. Diese ersten Werte sind noch immer nicht sinnvoll zu verwenden.
...
Der Kalibrierungsfortschritt kann mit dieser Einstellung zur Information ausgegeben werden, hat aber auf die Funktion keinerlei Einfluss.
